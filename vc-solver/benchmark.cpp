...
#include "../clique-solver/upperbounds/upper_bounds.h"
#include "../clique-solver/reductions/color_branching.h"
 ...
 */
void branch_and_bound_for_benchmark(Graph& G, vector<Vertex*>& maximum_clique,chrono::steady_clock::time_point& timeout, std::set<TECHNIQUE> config){
    if(timeout < chrono::steady_clock::now()){
